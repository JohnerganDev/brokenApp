	...
	<div class="control-group">
		...
		<div class="controls">
			<select id="country" name="country">
				<option value="Ireland"<?php echo output_selected($product['taste'],'Ireland') ?>>Ireland</option>
				<option value="UK"<?php echo output_selected($product['taste'],'UK') ?>>UK</option>
				<option value="France"<?php echo output_selected($product['taste'],'France') ?>>France</option>
